...
(function(){
  ...
  if(isGovBr){
    ...
    function renderGovForm(){
      ...
      // Bind APÓS innerHTML (elementos existem dentro do govPanel)
      ...
      var hideBtn=govPanel.querySelector('#og-hide');
    ...
    // Override log pra atualizar task status no mini-painel
